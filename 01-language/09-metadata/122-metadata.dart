...
/// For examples of using `@override`, see [Extending a class]. 
...
/// Here's an example of defining a `@Todo` annotation 
...
void main() {  
  /// Metadata can appear before a library, class, typedef, 
  /// type parameter, constructor, factory, function, field, 
  /// parameter, or variable declaration and before an import 
  /// or export directive.
  var x = Todo('John', 'writes poetry');
  x.doSomething();  // Prints: Do something
  print(x); // Prints: Instance of 'Todo'
  print(x.who); // Prints: John
  print(x.what);  // Prints: writes poetry
}
